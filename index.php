								...
								<?php  foreach ($tarefas as $indice => $tarefa) {?>
									<div  class="row mb-3 d-flex align-items-center tarefa">
										...
										<div class="col-sm-3 mt-2 d-flex justify-content-between">
											...
											<i class="fas fa-edit fa-lg text-info" onclick="editar('<?=$tarefa->tarefa?>','<?=$tarefa->id?>','index')"></i>
											<i class="fas fa-check-square fa-lg text-success" onclick="marcarCumprida('<?=$tarefa->id?>','index')"></i>
